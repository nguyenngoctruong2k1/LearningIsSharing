        ...
        if password_reset_form.is_valid():
            ...
            if associated_users.exists():
                for user in associated_users:
                    ...
                    c = {
                        "email": user.email,
                        'domain': 'cfc92e8c9c7f4d91b20c0824ee655715-0c9f5765-vm-80.vlab2.uit.edu.vn',
                        'site_name': 'Website',
                    ...
                    try:
                        send_mail(subject, email, 'butterflies.nnpt@gmail.com', [user.email], fail_silently=False)
